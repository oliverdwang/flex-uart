...
# DVE full session
# Saved on Wed Mar 23 16:28:59 2022
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{220 283} {2134 1296}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 401} {height 614} {dock_state left} {dock_on_new_line true} {child_hier_colhier 272} {child_hier_coltype 132} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
set DLPane.1 [gui_create_window -type DLPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line true -dock_extent 494]
...
gui_set_window_pref_key -window ${DLPane.1} -key dock_width -value_type integer -value 494
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 614
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 493} {height 614} {dock_state left} {dock_on_new_line true} {child_data_colvariable 284} {child_data_colvalue 149} {child_data_coltype 119} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1914} {height 300} {dock_state bottom} {dock_on_new_line true}}
