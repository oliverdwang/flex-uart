...
# DVE full session
# Saved on Tue Mar 22 17:59:27 2022
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{220 209} {2136 1224}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 403} {height 614} {dock_state left} {dock_on_new_line true} {child_hier_colhier 272} {child_hier_coltype 132} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 495} {height 614} {dock_state left} {dock_on_new_line true} {child_data_colvariable 284} {child_data_colvalue 149} {child_data_coltype 119} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1916} {height 302} {dock_state bottom} {dock_on_new_line true}}
