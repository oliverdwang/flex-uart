...
# DVE full session
# Saved on Thu Mar 24 14:05:06 2022
# Designs open: 1
...
gui_show_window -window ${TopLevel.2} -show_state maximized -rect {{2035 37} {3954 1199}}
...
gui_sg_addsignal -group "$_session_group_3" { top.dut.uart_write.clk top.dut.uart_write.rst_n top.dut.uart_write.tx_data_valid top.dut.uart_write.tx_data top.dut.uart_write.tx_data_ready top.dut.uart_write.tx_serial_out top.dut.uart_write.latched_tx_data top.dut.uart_write.count top.dut.uart_write.shift_out top.dut.uart_write.latch_data top.dut.uart_write.xfer_to_shift top.dut.uart_write.do_tx top.dut.uart_write.do_shift top.dut.uart_write.last_bit_tx top.dut.uart_write.ns top.dut.uart_write.cs }
...
gui_wv_zoom_timerange -id ${Wave.1} 0 447
gui_list_add_group -id ${Wave.1} -after {New Group} {Group1}
gui_list_select -id ${Wave.1} {top.dut.uart_write.tx_serial_out }
...
gui_marker_move -id ${Wave.1} {C1} 6245
