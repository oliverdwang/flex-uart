...
# DVE full session
# Saved on Tue Mar 22 16:14:55 2022
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{0 31} {1917 1047}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 404} {height 606} {dock_state left} {dock_on_new_line true} {child_hier_colhier 272} {child_hier_coltype 132} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 496} {height 606} {dock_state left} {dock_on_new_line true} {child_data_colvariable 284} {child_data_colvalue 149} {child_data_coltype 119} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
set Console.1 [gui_create_window -type Console -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 304]
gui_set_window_pref_key -window ${Console.1} -key dock_width -value_type integer -value 1860
gui_set_window_pref_key -window ${Console.1} -key dock_height -value_type integer -value 304
gui_set_window_pref_key -window ${Console.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1917} {height 303} {dock_state bottom} {dock_on_new_line true}}
...
catch { gui_list_select -id ${Data.1} {top.dut.uart_recv.clk top.dut.uart_recv.rst_n top.dut.uart_recv.raw_rx_bitstream top.dut.uart_recv.host_ready top.dut.uart_recv.clear_framing_err top.dut.uart_recv.rx_data top.dut.uart_recv.rx_data_valid top.dut.uart_recv.framing_err top.dut.uart_recv.overrun top.dut.uart_recv.rx_bitstream top.dut.uart_recv.active_rx top.dut.uart_recv.bit_ready top.dut.uart_recv.rx_bit top.dut.uart_recv.done top.dut.uart_recv.framing_err_internal top.dut.uart_recv.shift_in top.dut.uart_recv.xfer_to_buf top.dut.uart_recv.cs top.dut.uart_recv.ns }}
