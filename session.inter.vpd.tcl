...
# DVE full session
# Saved on Tue Mar 1 23:12:04 2022
# Designs open: 1
#   Sim: simv
...
#<Session mode="Full" path="/afs/ece.cmu.edu/usr/davidx/Private/18725/flex-uart/session.inter.vpd.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state maximized -rect {{0 23} {2559 1409}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 411} {height 770} {dock_state left} {dock_on_new_line true} {child_hier_colhier 272} {child_hier_coltype 132} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 769
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 503} {height 770} {dock_state left} {dock_on_new_line true} {child_data_colvariable 284} {child_data_colvalue 149} {child_data_coltype 119} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
set Console.1 [gui_create_window -type Console -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 536]
gui_set_window_pref_key -window ${Console.1} -key dock_width -value_type integer -value 2559
gui_set_window_pref_key -window ${Console.1} -key dock_height -value_type integer -value 536
gui_set_window_pref_key -window ${Console.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 2559} {height 535} {dock_state bottom} {dock_on_new_line true}}
...
gui_show_window -window ${TopLevel.2} -show_state maximized -rect {{2560 23} {4479 1049}}
...
gui_show_window -window ${TopLevel.3} -show_state maximized -rect {{0 23} {2559 1409}}
...
gui_sim_run Ucli -exe simv -args {-ucligui } -dir ../flex-uart -nosource
}
}
...
gui_open_source -id ${Source.1}  -replace -active top verif/uart-tb.sv
...
gui_wv_zoom_timerange -id ${Wave.1} 527 2305
gui_list_add_group -id ${Wave.1} -after {New Group} {Group1}
gui_list_select -id ${Wave.1} {top.dut.uart_recv.bit_ready }
...
gui_marker_move -id ${Wave.1} {C1} 1665
...
gui_wv_zoom_timerange -id ${Wave.2} 1475 2072
...
gui_marker_move -id ${Wave.2} {C1} 1665
